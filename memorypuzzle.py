"""
Created on Thu Nov  5 08:28:03 2020
@author: Changi
"""
import random, pygame, sys
from pygame.locals import *

FPS = 30 # frames/ sec general progam speed
WINDOWWIDTH = 640 #size of window width in pixels
WINDOWHEIGHT = 480 #size of wndow height in pixels
...
def main():
    ...
    pygame.display.set_caption('CHANGZ MEMORY GAME')
    
    mainBoard = getRandomizedBoard()
    revealedBoxes = generateRevealBoxesData(False)
    
    firstSelection = None #stores the (x, y) of the firstbox clicked.
        ...
        if boxx != None and boxy != None:
            ...
            if not revealedBoxes[boxx][boxy] and mouseClicked:
                ...
                if firstSelection == None:
                    ...
                    #Check if there is a match between the 2 icons
...
def getRandomizedBoard():
    ...
    random.shuffle(icons) #ranomize the order of the icons list
    numIconsUsed = int(BOARDWIDTH * BOARDHEIGHT / 2) #calculate how many icons are needed
    icons = icons[:numIconsUsed] * 2 # makes two of each
...
def getShapeAndColor(board, boxx, boxy):
    #shape value for x, y spot is troed in board[x][y][0]
